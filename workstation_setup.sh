...
sudo apt update
sudo apt upgrade
sudo apt install autoconf autoconf-doc automake bison build-essential cmake colordiff curl default-jdk dictd dict-freedict-fra-eng dict-gcide enscript ffmpeg fontconfig gcc gdb gfortran git gnuplot grads graphviz groff gtk-doc-tools htop imagemagick jq lftp libboost-all-dev libbz2-dev libcurl4-gnutls-dev libeigen3-dev libexif-dev libffi-dev libfuse2 libgc-dev libgdk-pixbuf2.0-dev libgif-dev libglib2.0-dev libgmp-dev libgsl-dev libgtk-3-dev libimage-exiftool-perl libimlib2-dev liblapack-dev liblzma-dev libmagickwand-dev libmpc-dev libmpfr-dev libncurses5-dev libopenblas-dev libreadline-dev libssl-dev libtool libunistring-dev libvirt-daemon libxft-dev lm-sensors lynx m4 m4-doc make neofetch ninja-build openssh-client openssh-server p7zip-full p7zip-rar parallel perl pv python3-pip python3-testresources python-is-python3 qemu-kvm rlwrap texlive-fonts-recommended texlive-plain-generic texlive-xetex unrar unzip virt-manager vlc xclip zlib1g zlib1g-dev 
