...
wget https://github.com/makew0rld/amfora/releases/download/v1.11.0/amfora_1.11.0_linux_64-bit
mv amfora_1.11.0_linux_64-bit amfora
chmod +x amfora
mv amfora ~/.local/bin
...
#before adding startup script, add OhMyREPL, Revise to base env
